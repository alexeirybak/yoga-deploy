...
export default async function CourseDescription({ params: { id } }: Props) {
  ...
  return (
    <div className="max-w-[1440px] px-[16px] md:px-[140px]">
      ...
      <div className="block xl:hidden relative bgLineTop max-[375px]:w-[300px] max-[375px]:h-[290px] h-[347px] right-0 bottom-0 overflow-hidden mx-auto -mt-[60px] -mb-[120px] z-10">
